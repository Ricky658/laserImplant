            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="marco-a m-0 p-0 pr-1">
                        <a href="{{url('/odontologia/especialidades')}}">
                        <img src="{{url('img/carillas_dentales/IMG_7773.JPG')}}">
                    </a>
                    <span class="etiqueta">Odontología & Estética Dental</span>
                    </div>
                </div>
                <div class="col-md-6">
        ...
        <div class="col-md-12">
            <div class="row">
                <div class="col-md-3">
                    ...
                    <span class="etiqueta">Dr. Renato Cisneros</span>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="marco-d m-0 p-0 pr-1">
                    <a href="{{url('/medicos/3/perfil')}}">
                        <img src="{{url('img/doctores/dra_carmen.JPG')}}">
                    </a>
                    <span class="etiqueta">Dra. Carmen Vallejo</span>
                    </div>
                </div>
                <div class="col-md-6">
