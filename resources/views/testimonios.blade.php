    ...
    <div class="row m-0">
        <div class="col-md-5 izq">
            <div class="offset-md-2 col-md-8">
                <h2>Mira lo que dicen <br> algunos de nuestros <br> Pacientes</h2>
                ...
                <h2 class="mt-3">Diseño de Sonrisa</h2>
                <p>
        ...
        <div class="col-md-7 der">
            <div class="offset-md-2 col-md-8">
                <iframe height="400" src="https://www.youtube.com/embed/8JyQfb8vR9U?si=05z5rgDaaLnb4rou" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            </div>
        </div>
    </div>
</div>
